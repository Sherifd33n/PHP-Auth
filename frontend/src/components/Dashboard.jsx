        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-xl font-bold text-indigo-600">Auth</h1>
            </div>
            <div className="flex items-center">
              <button
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
          <div className="p-8">
            <h2 className="text-3xl font-extrabold text-gray-900 mb-2">
              Welcome back,{" "}
              {user?.name || user?.full_name || user?.fullName || "User"}!
            </h2>
            ...
            <div className="mt-10 border-t border-red-100 pt-8">
              <div className="flex items-center justify-between bg-red-50 border border-red-200 rounded-lg p-5">
                ...
                <button
                  ...
                  className="ml-6 shrink-0 px-4 py-2 bg-red-600 text-white text-sm font-semibold rounded-lg hover:bg-red-700 transition shadow cursor-pointer">
                  Deactivate
                </button>
              </div>
            </div>
